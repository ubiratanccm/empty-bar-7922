...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/empty-bar-7922#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/empty-bar-7922
```

A live public deployment of this template is available at [https://empty-bar-7922.templates.workers.dev](https://empty-bar-7922.templates.workers.dev)
